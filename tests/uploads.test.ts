import fs from 'fs';
import type { ResponseLike } from 'api-dental-prod/internal/to-file';
import { toFile } from 'api-dental-prod/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('api-dental-prod/core/uploads');
    await expect(
